export const posts = [
  {
    ...
    description:
      'Neste fim de semana tem um super show preparado especialmente pra vocês! É dia 5 de dezembro. Espero vocês a partir das 21:30.',
    tags: [{ title: '#music' }, { title: '#energy' }],
    songName: 'Alive (It Feels Like) - Alok',
    videoUrl:
